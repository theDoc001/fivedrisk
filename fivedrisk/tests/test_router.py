...
class TestModelRouter:
    ...
    def test_green_d0_routes_local(self):
        ...
        assert config.is_local  # Low-5: tier by class, not by shipped model name
    ...
    def test_red_routes_to_opus(self):
        ...
        assert config.model_class == ModelClass.M4  # structure, not shipped name
    ...
    def test_orange_routes_to_sonnet_advisor(self):
        ...
        assert config.model_class == ModelClass.M3  # structure, not shipped name
...
class TestAdvisorToolConfig:
    ...
    def test_advisor_config_format(self):
        ...
        assert config["model"] is None  # Low-5: caller supplies the model
