...
- non-allowlisted destinations are blocked whenever an allowlist is declared. There is no setting that downgrades this to a warning: declaring an allowlist IS the enforcement decision
