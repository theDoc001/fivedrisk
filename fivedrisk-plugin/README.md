...
(Data, Tool, Reversibility, External, Autonomy), assigns a **GREEN / YELLOW /
ORANGE / RED** band, and gates execution: GREEN/YELLOW execute, ORANGE blocks
pending approval, RED is denied. A PostToolUse hook also scans tool output for
leakage. Every decision is logged to a local SQLite audit trail.
